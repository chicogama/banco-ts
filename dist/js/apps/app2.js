...
export function app2() {
    ...
    cliente.adicinaEndereco(new Endereco("68900000", "Av. São José", "123", "N/A", "Santana", "Amapá"));
    cliente.adicinaEndereco(new Endereco("68900222", "Av. Fab", "773", "Apt. 22", "Mazagão", "Amapá"));
